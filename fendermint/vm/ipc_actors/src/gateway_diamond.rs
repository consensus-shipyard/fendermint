...
pub mod gateway_diamond {
    ...
    impl ::core::convert::From<AppliedTopDownNonceCall> for GatewayDiamondCalls {
        fn from(value: AppliedTopDownNonceCall) -> Self {
            Self::AppliedTopDownNonce(value)
        }
    }
    impl ::core::convert::From<BottomUpCheckPeriodCall> for GatewayDiamondCalls {
        fn from(value: BottomUpCheckPeriodCall) -> Self {
            Self::BottomUpCheckPeriod(value)
        }
    }
    impl ::core::convert::From<BottomUpCheckpointAtEpochCall> for GatewayDiamondCalls {
    ...
    for GatewayDiamondCalls {
        fn from(value: BottomUpCheckpointHashAtEpochCall) -> Self {
            Self::BottomUpCheckpointHashAtEpoch(value)
        }
    }
    impl ::core::convert::From<BottomUpCheckpointsCall> for GatewayDiamondCalls {
        fn from(value: BottomUpCheckpointsCall) -> Self {
            Self::BottomUpCheckpoints(value)
        }
    }
    impl ::core::convert::From<BottomUpNonceCall> for GatewayDiamondCalls {
        fn from(value: BottomUpNonceCall) -> Self {
            Self::BottomUpNonce(value)
        }
    }
    impl ::core::convert::From<CrossMsgFeeCall> for GatewayDiamondCalls {
        fn from(value: CrossMsgFeeCall) -> Self {
            Self::CrossMsgFee(value)
        }
    }
    impl ::core::convert::From<ExecutableQueueCall> for GatewayDiamondCalls {
        fn from(value: ExecutableQueueCall) -> Self {
            Self::ExecutableQueue(value)
        }
    }
    impl ::core::convert::From<GetAppliedTopDownNonceCall> for GatewayDiamondCalls {
        fn from(value: GetAppliedTopDownNonceCall) -> Self {
            Self::GetAppliedTopDownNonce(value)
        }
    }
    impl ::core::convert::From<GetGenesisEpochCall> for GatewayDiamondCalls {
        fn from(value: GetGenesisEpochCall) -> Self {
            Self::GetGenesisEpoch(value)
        }
    }
    impl ::core::convert::From<GetNetworkNameCall> for GatewayDiamondCalls {
        fn from(value: GetNetworkNameCall) -> Self {
            Self::GetNetworkName(value)
        }
    }
    impl ::core::convert::From<GetSubnetCall> for GatewayDiamondCalls {
        fn from(value: GetSubnetCall) -> Self {
            Self::GetSubnet(value)
        }
    }
    impl ::core::convert::From<GetSubnetTopDownMsgCall> for GatewayDiamondCalls {
        fn from(value: GetSubnetTopDownMsgCall) -> Self {
            Self::GetSubnetTopDownMsg(value)
        }
    }
    impl ::core::convert::From<GetSubnetTopDownMsgsLengthCall> for GatewayDiamondCalls {
        fn from(value: GetSubnetTopDownMsgsLengthCall) -> Self {
            Self::GetSubnetTopDownMsgsLength(value)
        }
    }
    impl ::core::convert::From<GetTopDownMsgsCall> for GatewayDiamondCalls {
    ...
    impl ::core::convert::From<InitializedCall> for GatewayDiamondCalls {
        fn from(value: InitializedCall) -> Self {
            Self::Initialized(value)
        }
    }
    impl ::core::convert::From<LastVotingExecutedEpochCall> for GatewayDiamondCalls {
        fn from(value: LastVotingExecutedEpochCall) -> Self {
            Self::LastVotingExecutedEpoch(value)
        }
    }
    impl ::core::convert::From<ListSubnetsCall> for GatewayDiamondCalls {
        fn from(value: ListSubnetsCall) -> Self {
            Self::ListSubnets(value)
        }
    }
    impl ::core::convert::From<MajorityPercentageCall> for GatewayDiamondCalls {
        fn from(value: MajorityPercentageCall) -> Self {
            Self::MajorityPercentage(value)
        }
    }
    impl ::core::convert::From<MinStakeCall> for GatewayDiamondCalls {
        fn from(value: MinStakeCall) -> Self {
            Self::MinStake(value)
        }
    }
    impl ::core::convert::From<PostboxCall> for GatewayDiamondCalls {
        fn from(value: PostboxCall) -> Self {
            Self::Postbox(value)
        }
    }
    impl ::core::convert::From<SubnetsCall> for GatewayDiamondCalls {
        fn from(value: SubnetsCall) -> Self {
            Self::Subnets(value)
        }
    }
    impl ::core::convert::From<TopDownCheckPeriodCall> for GatewayDiamondCalls {
        fn from(value: TopDownCheckPeriodCall) -> Self {
            Self::TopDownCheckPeriod(value)
        }
    }
    impl ::core::convert::From<TotalSubnetsCall> for GatewayDiamondCalls {
        fn from(value: TotalSubnetsCall) -> Self {
            Self::TotalSubnets(value)
        }
    }
    impl ::core::convert::From<TotalWeightCall> for GatewayDiamondCalls {
