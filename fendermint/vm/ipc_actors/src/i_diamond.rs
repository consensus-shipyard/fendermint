...
pub mod i_diamond {
    ...
    impl<M> ::core::fmt::Debug for IDiamond<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IDiamond)).field(&self.address()).finish()
        }
    }
    ...
    impl ::ethers::core::abi::AbiDecode for IDiamondCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for IDiamondCalls {
    ...
    impl ::core::fmt::Display for IDiamondCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::AppliedTopDownNonce(element) => {
